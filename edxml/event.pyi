...
class AttachmentSet(OrderedDict):
    def __init__(self, attachments: Dict[str, str] = None, update_attachment=None):
        super().__init__()
...
class EDXMLEvent(MutableMapping):
    ...
    def __update_attachment(self, attachment_name: str, value: str) -> None: ...
    ...
    @property
    def attachments(self) -> Union[AttachmentSet, Dict[str, str]]: ...

    @attachments.setter
    def attachments(self, new_attachments: Dict[str, str]) -> None: ...

    def replace_invalid_characters(self, replace: bool=True) -> 'EDXMLEvent': ...

    def get_any(self, property_name: str, default: str=None) -> Union[Any, None]: ...
    ...
    def create(cls, properties: Dict[str, Union[Any, Set[Any]]], event_type_name: str = None, source_uri: str = None,
               parents: List[str] = None, attachments: Dict[str, str] = None) -> 'EDXMLEvent': ...
    ...
    def get_attachments(self) -> Union[AttachmentSet, Dict[str, str]]: ...
