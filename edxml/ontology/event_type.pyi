...
class EventType(OntologyElement):
    ...
    def create_relation(self, source: str, target: str, description: str, type_class: str, type_predicate: str,
                        confidence: float = 1.0, directed: bool = True): ...
    ...
    def generate_relax_ng(self, ontology: edxml.ontology.Ontology) -> etree.ElementTree: ...
