...
class Ontology(object):
  ...
  def _addEventType(self, eventType: edxml.ontology.EventType) -> 'Ontology': ...

  def _addObjectType(self, objectType: edxml.ontology.ObjectType) -> 'Ontology': ...

  def _addConcept(self, concept: edxml.ontology.Concept) -> 'Ontology': ...

  def _addEventSource(self, eventSource: edxml.ontology.EventSource) -> 'Ontology': ...
  ...
  def ValidateReporterString(self, EventType: edxml.ontology.EventType, string: str) -> 'Ontology': ...

  def Validate(self) -> 'Ontology': ...

  @classmethod
  def Read(cls, definitionsElement: etree.Element) -> 'Ontology': ...

  def AddBrick(self, ontologyBrick: edxml.ontology.Brick) -> 'Ontology': ...

  def Update(self, otherOntology: Union[lxml.etree.Element,'Ontology']) -> 'Ontology': ...
