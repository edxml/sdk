...
class Ontology(object):
    ...
    def get_object_type(self, name: str) -> Union[edxml.ontology.ObjectType, None]: ...

    def get_concept(self, name: str) -> Union[edxml.ontology.Concept, None]: ...
    ...
    def validate_template(self, event_type: edxml.ontology.EventType, template: str) -> 'Ontology': ...
