...
class Ontology(OntologyElement):
    ...
    def create_object_type(self, name: str, display_name_singular: str = None, display_name_plural: str = None,
                           description: str = None, data_type: str = 'string:0:cs:u') -> edxml.ontology.ObjectType: ...
    ...
    def generate_graph_parents_children(self, graph: graphviz.Digraph): ...

    @staticmethod
    def _gv_generate_parent_child(graph: graphviz.Digraph, parent: edxml.ontology.EventType, child: edxml.ontology.EventType): ...

    @staticmethod
    def _get_property_node_title(title: str, subtitle: str, subsubtitle: str) -> str: ...

    def _add_shared_object_edges(self, graph: graphviz.Digraph, event_type_name: str, property_name: str, concept_name: str, type_property_concepts) -> None: ...

    def generate_graph_property_concepts(self, graph: graphviz.Digraph) -> None: ...
