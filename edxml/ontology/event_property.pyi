...
class EventProperty(object):
  ...
  def GetConceptConfidence(self) -> int: ...
  ...
  def RelateTo(self, TypePredicate: str, TargetPropertyName: str, Reason: str = None, Confidence: int = 10, Directed: bool = True) -> edxml.ontology.PropertyRelation: ...

  def RelateInter(self, TypePredicate: str, TargetPropertyName: str, Reason: str = None, Confidence: int = 10, Directed: bool = True) -> edxml.ontology.PropertyRelation: ...

  def RelateIntra(self, TypePredicate: str, TargetPropertyName: str, Reason: str = None,Confidence: int = 10, Directed: bool = True) -> edxml.ontology.PropertyRelation: ...
  ...
  def Identifies(self, ConceptName: str, Confidence: int) -> 'EventProperty': ...
