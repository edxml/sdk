...
class Transcoder(EDXMLBase):
  ...
  def IsPostProcessor():
    ...
    Returns:
       bool:
    """
    # TODO: Change method to @classmethod and use below check
    # to determine calling post processor or not.
    # Check if our own empty PostProcess() method has been
    # overridden by a class extension.
    #thisMethod = getattr(cls, 'PostProcess')
