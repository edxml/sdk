...
class RecordTranscoder(object):
    ...
    for the events that the transcoder intends to produce. Record transcoders can
    override this method to generate their own event types.

    Alternatively, record transcoders can populate a number of class constants describing
    ...
    improving the readability of the record transcoder.
    """
    ...
    def generate_event_types(self):
        ...
        various record transcoders. Yields tuples containing pairs of event type
    ...
    def create_event_type(cls, event_type_name, ontology):
        ...
        the class attributes of the record transcoder. It returns the
        resulting event type. Record transcoders can optionally tune the
