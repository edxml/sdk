...
class TranscoderMediator(object):
    ...
    def enable_event_repair(self, event_type_name):
        ...
        invalid event generated by the mediator it will try to repair
        the event by normalizing object values.
        When also configured to ignore invalid object values the mediator
        will remove object values in case normalization does not work.
    ...
    def _create_writer(self):
        ...
        for event_type_name in self.__repairable_event_types:
            self._writer.enable_event_repair(event_type_name)
